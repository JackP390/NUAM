...
urlpatterns = [
    ...
    path('client/<int:cliente_id>/detalle/', views.client_detail, name='client_detail'),
    path('client/<int:cliente_id>/add-rating/', views.add_calificacion, name='add_calificacion'),
